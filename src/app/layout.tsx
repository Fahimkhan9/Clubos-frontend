...
export const metadata: Metadata = {
  ...
  authors: [{ name: "ClubOS Team", url: "https://clubos-frontend.vercel.app" }],
  creator: "ClubOS",
  openGraph: {
    ...
    url: "https://clubos-frontend.vercel.app",
    siteName: "ClubOS",
    images: [
      {
        url: "https://clubos-frontend.vercel.app/og-image.png", // replace with actual hosted OG image
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://clubos-frontend.vercel.app/og-image.png"],
    creator: "@fahimalif077", // optional
  },
  metadataBase: new URL("https://clubos-frontend.vercel.app"),
  robots: {
    index: true,
    follow: true,
    googleBot: {
